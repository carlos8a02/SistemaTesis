...
<tr>
    ...
    <td>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1 or $_SESSION["usuario"]["privilegio"] == 2){?>
    <a href='#.php?id=<?php echo $row['id']?>;' class="btn btn-success btn-sm">Actualizar</a>
	<?php } ?>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1){?>
    <a href="eliminaRegistro.php?id=<?php echo $row['id']?>;" class="btn btn-danger  btn-sm">Eliminar</a>
    <?php } ?>
	</td>	
 </tr>
 <script>
...
<tr>
	...
	<?php } ?>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1){?>
    <a href="eliminaRegistro2.php?id=<?php echo $row['id']?>;" class="btn btn-danger  btn-sm">Eliminar</a>
    <?php } ?>
	</td>
 </tr>
<?php
...
<tr>
	...
	<?php } ?>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1){?>
    <a href="eliminaRegistro3.php?id=<?php echo $row['id']?>;" class="btn btn-danger  btn-sm">Eliminar</a>
    <?php } ?>
	</td>
 </tr>
<?php
...
<tr>
	...
	<?php } ?>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1){?>
    <a href="eliminaRegistro4.php?id=<?php echo $row['id']?>;" class="btn btn-danger  btn-sm">Eliminar</a>
    <?php } ?>
	</td>
 </tr>
<?php
...
<tr>
	...
	<?php } ?>
	<?php if ($_SESSION["usuario"]["privilegio"] == 1){?>
    <a href="eliminaRegistro5.php?id=<?php echo $row['id']?>;" class="btn btn-danger  btn-sm">Eliminar</a>
    <?php } ?>
	</td>
 </tr>
<?php
