...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../assets/sw2/bootstrap4/css/bootstrap.min.css">	
      
    <link rel="stylesheet" href="../assets/sw2/plugins/sweetAlert2/sweetalert2.min.css">  
      
    <link rel="stylesheet" href="../assets/sw2/plugins/animate.css/animate.css">  
	<link rel="stylesheet" href="../assets/sw2/estilos.css">
...
<!--        <button id="btn0">alert</button>-->
    ...
    <script src="../assets/sw2/jquery/jquery-3.3.1.min.js"></script>	 	
    <script src="../assets/sw2/popper/popper.min.js"></script>	 	 	
    <script src="../assets/sw2/bootstrap4/js/bootstrap.min.js"></script>
	  
    <!--    Plugin sweet Alert 2  -->
	<script src="../assets/sw2/plugins/sweetAlert2/sweetalert2.all.min.js"></script>
      
    <script src="../assets/sw2/codigo.js"></script> 	  
